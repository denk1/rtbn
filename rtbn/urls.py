...
urlpatterns = [
    ...
    path('<int:pk>/change/', views.add_or_change_person, name='change_person'),
    path('<int:pk>/delete/', views.delete_person, name='delete_person'),
    ...
    path("cemetery_item/", include("cemetery.urls", namespace="cemetery")),
